...
| GR012 | [`public-attribute-properties`](https://wkentaro.github.io/gruff/rules/public-attribute-properties/) | Public instance state uses underscore-prefixed storage and an explicit property. |
