...
| GR012 | [`public-data-properties`](https://wkentaro.github.io/gruff/rules/public-data-properties/) | Public instance data uses explicit properties with underscore-prefixed storage. |
